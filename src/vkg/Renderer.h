  ...
  namespace vkg
  {
    ...
    class RendererImpl
    {
      private:
         ...
         */
        void bind( const char* name, const nyx::vkg::Buffer& buffer, unsigned element_size, unsigned count ) ;
...
//    template<nyx::ImageFormat ... Formats>
//    void Renderer<Formats...>::addAttachment( const nyx::Attachment& attachment )
//    {
//    
//    }
